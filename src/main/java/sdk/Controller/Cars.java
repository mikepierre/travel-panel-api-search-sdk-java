...
public class Cars {
    ...
    public String cancel(HashMap<String, String> params){
            ...
            Map<String, Object> yaml = this.getYaml();
            String auth = (String) yaml.get("auth");
            String url = (String) yaml.get("cars_cancel");
    ...
    public String locations(HashMap<String, String> params){
    ...
    public String rates(HashMap<String, String> params){
